    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="{{ url()->current() }}">
            <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                ...
                {{-- <img class="hidden dark:block" src="https://www.cybermakassar.com/asset/foto_berita/siakad-app.png"
                    alt="Logo" /> --}}
            </span>
                        ...
                        <li>
                            <a href="{{ route('absen.harian') }}" class="menu-item group" :class="@json(Route::is('absen.harian')) ?
                                ...
                                <svg class="fill-none" :class="@json(Route::is('absen.harian')) ?
                                                ...
                                                'stroke-gray-500 dark:stroke-gray-400'" xmlns="http://www.w3.org/2000/svg"
