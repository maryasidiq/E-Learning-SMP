            ...
            <div>
                ...
                @elseif (Auth::user()->role == 'Guru' && Auth::user()->guru(Auth::user()->id_card))
                    <ul class="flex flex-col gap-4 mb-6">
                        ...
                        <!-- Menu Item Quis -->
                        <li>
                            <a href="{{ route('quis.index') }}" class="menu-item group" :class="@json(Route::is('quis.index')) || @json(Route::is('quis.create')) ||
                                                                @json(Route::is('quis.show')) || @json(Route::is('quis.edit')) ||
                                                                @json(Route::is('quis.create-soal')) || @json(Route::is('quis.edit-soal')) ?
                                                                'menu-item-active' : 'menu-item-inactive'">
                                <svg class="fill-none" :class="@json(Route::is('quis.index')) || @json(Route::is('quis.create')) ||
                                                                    @json(Route::is('quis.show')) || @json(Route::is('quis.edit')) ||
                                                                    @json(Route::is('quis.create-soal')) || @json(Route::is('quis.edit-soal')) ?
                                                                    '!stroke-brand-400 !dark:stroke-brand-500' :
                                                                    'stroke-gray-500 dark:stroke-gray-400'"
                        ...
                        <!-- Menu Item Ujian -->
                        <li>
                            <a href="{{ route('ujian.index') }}" class="menu-item group" :class="@json(Route::is('ujian.index')) || @json(Route::is('ujian.create')) ||
                                                                @json(Route::is('ujian.show')) || @json(Route::is('ujian.edit')) ||
                                                                @json(Route::is('ujian.create-soal')) || @json(Route::is('ujian.edit-soal')) ?
                                                                'menu-item-active' : 'menu-item-inactive'">
                                <svg class="fill-none" :class="@json(Route::is('ujian.index')) || @json(Route::is('ujian.create')) ||
                                                                    @json(Route::is('ujian.show')) || @json(Route::is('ujian.edit')) ||
                                                                    @json(Route::is('ujian.create-soal')) || @json(Route::is('ujian.edit-soal')) ?
                                                                    '!stroke-brand-400 !dark:stroke-brand-500' :
                                                                    'stroke-gray-500 dark:stroke-gray-400'"
