<header x-data="{ menuToggle: false }"
    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <h1 class="lg:hidden text-2xl dark:text-gray-300">@yield('pageTitle')</h1>
            ...
            <div class="hidden lg:flex lg:items-center">
                <h1 class="text-2xl dark:text-gray-300">@yield('pageTitle')</h1>
            </div>
        </div>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                ...
                <div x-show="dropdownOpen"
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit"
                            class="w-full group text-theme-sm mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-red-500 hover:text-gray-100 dark:text-gray-400 dark:hover:bg-red-500 dark:hover:text-gray-300">
                            <svg class="fill-gray-500 group-hover:fill-gray-100 dark:group-hover:fill-gray-300"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
