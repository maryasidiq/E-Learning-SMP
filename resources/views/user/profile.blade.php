            ...
            <form action="{{ route('pengaturan.ubah-profile') }}" method="post">
                ...
                <div class="card-body">
                    @if (Auth::user()->role == "Guru")
                        <div class="row">
                            <input type="hidden" name="role"
                                value="{{ Auth::user()->guru(Auth::user()->id_card) ? Auth::user()->guru(Auth::user()->id_card)->role : Auth::user()->role }}">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="jk" name="jk" class="select2bs4 form-control @error('jk') is-invalid @enderror">
                                        ...
                                        <option value="L" @if (Auth::user()->guru(Auth::user()->id_card) && Auth::user()->guru(Auth::user()->id_card)->jk == 'L') selected @endif>Laki-Laki
                                        </option>
                                        <option value="P" @if (Auth::user()->guru(Auth::user()->id_card) && Auth::user()->guru(Auth::user()->id_card)->jk == 'P') selected @endif>Perempuan
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                    ...
                    @elseif (Auth::user()->role == "Siswa")
                        <div class="row" name="role"
                            value="{{ Auth::user()->siswa(Auth::user()->no_induk) ? Auth::user()->siswa(Auth::user()->no_induk)->role : Auth::user()->role }}">
                            <input type="hidden">
                            <div class="col-md-6">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="jk" name="jk" class="select2bs4 form-control @error('jk') is-invalid @enderror">
                                        <option value="">-- Pilih Jenis Kelamin --</option>
                                        <option value="L" @if (Auth::user()->siswa(Auth::user()->no_induk) && Auth::user()->siswa(Auth::user()->no_induk)->jk == 'L') selected @endif>Laki-Laki
                                        </option>
                                        <option value="P" @if (Auth::user()->siswa(Auth::user()->no_induk) && Auth::user()->siswa(Auth::user()->no_induk)->jk == 'P') selected @endif>Perempuan
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
