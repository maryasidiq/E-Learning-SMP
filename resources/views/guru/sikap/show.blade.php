                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($data->sikap($data->id) && $data->sikap($data->id)['id'])
                                                    <input type="hidden" name="sikap_id" class="sikap_id_{{$data->id}}"
                                            ...
                                            @if ($data->sikap($data->id) && $data->sikap($data->id)['sikap_1'])
                                                <td class="ctr">
                                                    ...
                                                    <input type="hidden" name="sikap_1" class="sikap_1_{{$data->id}}"
                                            ...
                                            @else
                                                <td class="ctr sub_{{$data->id}}"><button type="button" id="submit-{{$data->id}}"
