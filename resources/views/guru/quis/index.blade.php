...
@section('pageTitle', 'Quis')
@section('title', 'Quis')
@section('content')
    <h1 class="text-2xl mb-4 dark:text-gray-300">Daftar Quis</h1>
    <div class="mb-4">
        <a href="{{ route('quis.create') }}"
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30">
                                ...
                                <td class="px-5 py-4 sm:px-6">
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('quis.show', Crypt::encrypt($item->id)) }}"
                                        ...
                                        <a href="{{ route('quis.edit', Crypt::encrypt($item->id)) }}"
                                        ...
                                        <form action="{{ route('quis.destroy', $item->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                ...
                                                onclick="return confirm('Apakah Anda yakin ingin menghapus quis ini?')">
                                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-300">Belum ada quis</h3>
            <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan quis pertama Anda.</p>
        </div>
    @endif
@endsection