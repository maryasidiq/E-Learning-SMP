                            ...
                            @foreach ($siswa as $data)
                                ...
                                <tr class="dark:text-white">
                                    ...
                                    @if ($data->nilai($data->id))
                                        ...
                                        <td class="px-4 py-2">
                                            <textarea class="w-full p-2 border rounded bg-gray-100 dark:bg-gray-900 dark:border"
                                        ...
                                        @else
                                            <td class="px-4 py-2 text-center">
                                                <input type="text" name="nilai" maxlength="2" onkeypress="return inputAngka(event)"
                                            ...
                                            <td class="px-4 py-2">
                                                <textarea
                                                    class="w-full p-2 border rounded bg-gray-100 dark:bg-gray-900 dark:border deskripsi_{{ $data->id }}"
                                                    disabled></textarea>
                                            </td>
                                            <td class="px-4 py-2 text-center">
                                    ...
                                    @else
                                        ...
                                        <td class="px-4 py-2 text-center">
                                            <input type="text" name="predikat" placeholder="-" class="form-input text-center"
                                                disabled>
                                        </td>
                                        <td class="px-4 py-2">
                                            <textarea class="w-full p-2 border rounded bg-gray-100 dark:bg-gray-900 dark:border"
                                        ...
                                        <td class="px-4 py-2 text-center">
                                            <span
                                                class="bg-yellow-500 flex items-center justify-center w-8 h-8 rounded-full text-white">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <tbody>
                            <form action="" method="post" id="formRapot">
                                ...
                                <tr>
                                    ...
                                    <td class="ctr">
                                        <div class="kp_{{$data->id}} text-center">{{ $data->nilai($data->id)->k_predikat
                                            }}</div>
                                    </td>
                                    <td class="ctr">
                                        <textarea class="form-control swal2-textarea textarea-rapot" cols="50" rows="5"
